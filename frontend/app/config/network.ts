...
export const CONTRACT_ADDRESSES = {
  MARKET_FACTORY: process.env.NEXT_PUBLIC_MARKET_FACTORY_ADDRESS || '0x1642dD5c38642f91E4aa0025978b572fe30Ed89d',
  MANAGER: process.env.NEXT_PUBLIC_MANAGER_ADDRESS || '0xfbC451FBd7E17a1e7B18347337657c1F2c52B631'
};
